...
#'/home/cerendikmen/Colorful-Image-Colorization/tinyimagenet/n01443537/images'
...
class DataGenSequence(Sequence):
    def __init__(self, usage):
        ...
        # these txt files must be updated to our data, DONE
        if usage == 'train':
        ...
        q_ab = np.load("data/cifar_pts_in_hull_new.npy")
...
def split_data():
    ...
    # these files should be adjusted to our data, DONE
